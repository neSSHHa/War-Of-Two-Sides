...
namespace WarOfTwoSides.Models.DefaultValues
{
	public static class Default_Value
	{
		...
		public const int WARLOCK_HEALTH = 5;
		...
		public const int WARGLAIVES_BASE_DEMAGE = 3;
		public const int WARGLAIVES_ATTACK_DEMAGE = 2;
		public const int WARGLAIVES_MAGIC_DEMAGE = 2;
		public const int WARGLAIVES_DURABILITY = 100;

		public const int WAND_BASE_DEMAGE = 1;
		public const int WAND_ATTACK_DEMAGE = 1;
		public const int WAND_MAGIC_DEMAGE = 8;
		public const int WAND_DURABILITY = 30;

		public const int SWORD_BASE_DEMAGE = 2;
		public const int SWORD_ATTACK_DEMAGE = 3;
		public const int SWORD_MAGIC_DEMAGE = 1;
		public const int SWORD_DURABILITY = 80;

		public const int SPEAR_BASE_DEMAGE = 2;
		public const int SPEAR_ATTACK_DEMAGE = 5;
		public const int SPEAR_MAGIC_DEMAGE = 1;
		public const int SPEAR_DURABILITY = 60;

		public const int HAMMER_BASE_DEMAGE = 5;
		public const int HAMMER_ATTACK_DEMAGE = 4;
		public const int HAMMER_MAGIC_DEMAGE = 1;
		public const int HAMMER_DURABILITY = 110;

		public const int DEMONCLAW_BASE_DEMAGE = 2;
		public const int DEMONCLAW_ATTACK_DEMAGE = 3;
		public const int DEMONCLAW_MAGIC_DEMAGE = 3;
		public const int DEMONCLAW_DURABILITY = 1000;

		public const int DAGGER_BASE_DEMAGE = 2;
		public const int DAGGER_ATTACK_DEMAGE = 2;
		public const int DAGGER_MAGIC_DEMAGE = 1;
		public const int DAGGER_DURABILITY = 70;

		public const int BOW_BASE_DEMAGE = 1;
		public const int BOW_ATTACK_DEMAGE = 6;
		public const int BOW_MAGIC_DEMAGE = 1;
		public const int BOW_DURABILITY = 20;

		public const int BOOKOFEVOKING_BASE_DEMAGE = 1;
		public const int BOOKOFEVOKING_ATTACK_DEMAGE = 1;
		public const int BOOKOFEVOKING_MAGIC_DEMAGE = 5;
		public const int BOOKOFEVOKING_DURABILITY = 10;
